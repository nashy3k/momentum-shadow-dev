...
export default async function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white p-8">
      {/* Guest View Banner */}
      {!session?.user && (
        <div className="mb-8 p-4 bg-gradient-to-r from-indigo-900/40 to-cyan-900/40 border border-indigo-500/30 rounded-2xl flex items-center justify-between shadow-2xl backdrop-blur-md">
          <div className="flex items-center gap-4">
            <div className="p-2 bg-indigo-500/20 rounded-lg text-indigo-400">
              <Zap size={20} />
            </div>
            <div>
              <p className="text-sm font-bold text-indigo-100">Momentum is running in Demo Mode</p>
