    ...
    <div className="min-h-screen bg-[#050505] text-white p-8">
      ...
      <nav className="flex justify-between items-center mb-12">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-black tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-white to-zinc-500 italic">
            MOMENTUM <span className="text-blue-500 font-bold not-italic">CENTER</span>
          </h1>
        </div>
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2 px-4 py-2 bg-zinc-800 rounded-full text-sm font-medium">
            <MessageSquare className="w-4 h-4" />
            Discord Connected
          </div>
          <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-blue-500 to-cyan-500 p-[1px]">
