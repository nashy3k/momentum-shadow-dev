...
// Schedule: TEST MODE -> 10:30 PM KL (14:30 UTC)
console.log('[Scheduler] Initializing Test Patrol (Scheduled for 10:30 PM KL)...');
cron.schedule('30 14 * * *', async () => {
    // Run at 14:30 UTC -> 22:30 (10:30 PM) KL Time
    console.log('[Scheduler] 🕗 It is 10:30 PM KL. Starting Scheduled Test Patrol...');
    await runPatrol();
});
